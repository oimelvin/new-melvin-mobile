...
const es: LanguageProps = {
	...
	workOrderActions: {
		...
		checklist: {
			checklist: 'Checklist',
			selectDefaultChecklist: 'Seleccionar checklist predeterminado',
			removeDefaultChecklist: 'Eliminar checklist predeterminado',
			addManualChecklist: 'Añadir checklist manual',
	...
	filterSchedule: {
		filterSchedule: 'Filtrar la programación',
		filterWorkOrders: 'Filtrar órdenes de servicio',
	},
	solicitation: {},
	addSolicitation: {
		addSolicitation: 'Añadir solicitud',
		editSolicitation: 'Editar solicitud',
		applicant: 'Solicitante',
		informAnApplicant: 'Informa un solicitante',
		channel: 'Canal',
		selectAChannel: 'Seleccione un canal',
		branch: 'Sucursal',
		selectABranch: 'Seleccione una sucursal',
		noBranchesFound: 'No se encontró ninguna sucursal.',
		sector: 'Sector',
		...
		describeYourSolicitation: 'Describa su solicitud',
	},
	material: {
