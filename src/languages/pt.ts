...
const pt: LanguageProps = {
	...
	filterSchedule: {
		filterSchedule: 'Filtrar programação',
		filterWorkOrders: 'Filtrar ordens de serviço',
	},
	solicitation: {},
	addSolicitation: {
		...
		informAnApplicant: 'Informe um solicitante',
		channel: 'Canal',
		selectAChannel: 'Selecione um canal',
		branch: 'Filial',
		selectABranch: 'Selecionar filial',
		noBranchesFound: 'Nenhuma filial encontrada.',
		sector: 'Setor',
		...
		describeYourSolicitation: 'Descreva sua solicitação',
	},
	material: {
		materials: 'Materiais',
