...
interface FiltroOrdemServicoHookDataProps {
	filiais: Filial[]
	setores: Setor[]
	ativos: Ativo[]
	familias: Familia[]
...
interface FiltroOrdemServicoHookHandlesProps {
...
export interface FiltroOrdemServicoHookProps {
	data: FiltroOrdemServicoHookDataProps
	handles: FiltroOrdemServicoHookHandlesProps
}

const useFiltroOrdemServicoHook = () => {
...
export default useFiltroOrdemServicoHook
