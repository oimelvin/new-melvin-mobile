...
import { FiltroOrdemServicoPageContainer } from './styles'
...
import useFiltroOrdemServicoHook from './hooks'
import { i18n } from '@languages/index'
import { BottomTabNavigatorParamList } from '@routes/BottomTabNavigator'

type FiltroOrdemServicoPageProp = BottomTabNavigationProp<
	BottomTabNavigatorParamList,
	'SchedulePage'
>

const FiltroOrdemServicoPage: React.FC = () => {
	const { navigate } = useNavigation<FiltroOrdemServicoPageProp>()

	const { data, handles } = useFiltroOrdemServicoHook()
	...
	return (
		<KeyboardAvoidingView>
			<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
				<FiltroOrdemServicoPageContainer>
...
export default FiltroOrdemServicoPage
