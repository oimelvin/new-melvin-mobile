...
interface FiltroSolicitacaoHookDataProps {
	filiais: Filial[]
	setores: Setor[]
	ativos: Ativo[]
	familias: Familia[]
...
interface FiltroSolicitacaoHookHandlesProps {
...
export interface FiltroSolicitacaoHookProps {
	data: FiltroSolicitacaoHookDataProps
	handles: FiltroSolicitacaoHookHandlesProps
}

const useFiltroSolicitacaoHook = () => {
...
export default useFiltroSolicitacaoHook
